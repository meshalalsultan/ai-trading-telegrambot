...
if (isset($update['callback_query'])) {
    ...
    if (str_starts_with($data, 'service:')) {
        ...
        switch ($service['service_key']) {
            case 'chart_analysis':
                $serviceMessage =
                    "📸 اخترت: <b>تحليل شارت شامل</b>\n\n" .
                    "💰 التكلفة: <b>{$service['points_cost']}</b> نقطة\n\n" .
                    "أرسل صورة الشارت وسأساعدك على فهم:\n\n" .
                    "• من المسيطر الآن؟\n" .
                    "• أين مناطق الدعم والمقاومة المهمة؟\n" .
                    "• أين تصبح فكرة الصفقة غير صالحة؟\n" .
                    "• ما أهم المخاطر الموجودة؟\n\n" .
                    "📷 أرسل صورة الشارت الآن.";
                break;

            case 'recommendation_inspector':
            case 'check_signal':
                $serviceMessage =
                    "🧪 اخترت: <b>فحص توصية</b>\n\n" .
                    "💰 التكلفة: <b>{$service['points_cost']}</b> نقطة\n\n" .
                    "قبل أن تخاطر بأموالك...\n\n" .
                    "انسخ أي توصية من قناة أو شخص وسأفحص:\n\n" .
                    "• هل الوقف منطقي؟\n" .
                    "• هل الهدف يستحق؟\n" .
                    "• هل توجد مخاطر مخفية؟\n" .
                    "• هل التوصية ناقصة أو عشوائية؟\n\n" .
                    "📋 أرسل التوصية الآن.";
                break;
            ...
            case 'check_decision':
                $serviceMessage =
                    "🧠 اخترت: <b>قيّم قراري</b>\n\n" .
                    "💰 التكلفة: <b>{$service['points_cost']}</b> نقطة\n\n" .
                    "إذا كنت مترددًا قبل الدخول...\n\n" .
                    "اكتب سبب رغبتك في الدخول وسأساعدك على اكتشاف:\n\n" .
                    "• نقاط القوة في القرار\n" .
                    "• الأخطاء المحتملة\n" .
                    "• هل القرار مبني على خطة أم عاطفة؟\n\n" .
                    "✍️ اكتب قرارك الآن.";
                break;

            case 'risk_reward_check':
                $serviceMessage =
                    "⚖️ اخترت: <b>هل الصفقة تستحق؟</b>\n\n" .
                    "💰 التكلفة: <b>{$service['points_cost']}</b> نقطة\n\n" .
                    "أرسل:\n\n" .
                    "• سعر الدخول\n" .
                    "• وقف الخسارة\n" .
                    ...
                    "• جودة الصفقة\n" .
                    "• هل تستحق المخاطرة أصلًا؟\n\n" .
                    "📊 أرسل البيانات الآن.";
                break;

            case 'live_trade_review':
                $serviceMessage =
                    "🚨 اخترت: <b>أنا داخل صفقة الآن</b>\n\n" .
                    "💰 التكلفة: <b>{$service['points_cost']}</b> نقطة\n\n" .
                    "دخلت الصفقة وتشعر بالخوف أو التردد؟\n\n" .
                    "أرسل تفاصيل الصفقة أو صورة الشارت وسأساعدك على فهم:\n\n" .
                    "• هل سبب الدخول ما زال موجودًا؟\n" .
                    "• هل الخروج الآن منطقي؟\n" .
                    "• هل الخطة ما زالت سليمة؟\n\n" .
                    "📈 أرسل وضع الصفقة الحالي.";
                break;

            case 'loss_review':
                $serviceMessage =
                    "📚 اخترت: <b>درس من خطئي</b>\n\n" .
                    "💰 التكلفة: <b>{$service['points_cost']}</b> نقطة\n\n" .
                    "كل صفقة خاسرة تحتوي على درس.\n\n" .
                    "أرسل تفاصيل الصفقة أو صورة الشارت وسأوضح:\n\n" .
                    "• أين كان الخطأ؟\n" .
                    "• ما الذي كان يجب فعله؟\n" .
                    "• كيف تتجنب تكراره مستقبلاً؟\n\n" .
                    "🎯 أرسل الصفقة الآن.";
                break;
        ...
        sendMessage($chatId, $serviceMessage);
        exit;
    }
}
